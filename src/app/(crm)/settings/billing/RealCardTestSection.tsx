...
import styles from './RealCardTest.module.css';

const MAX_AMOUNT = 5;

export default function RealCardTestSection() {
  ...
  return (
    <>
      <div className="mb-3">
        <h2 className="text-xl font-semibold">סליקת כרטיס אשראי אמיתי</h2>
        <p className="text-sm text-muted-foreground">חיוב בדיקה של עד ₪5 בכרטיס אמיתי — למי שיודע מה הוא עושה</p>
      </div>

...
export default function DiscountsSection() {
  ...
  if (loading) {
    return (
      <>
        <h2 className="text-xl font-semibold mb-4">הנחות</h2>
        <CardGridSkeleton
          cards={3}
  ...
  return (
    <>
      <div className="mb-4">
        <h2 className="text-xl font-semibold">הנחות</h2>
        <p className="text-sm text-muted-foreground">רישום מוקדם, ילד נוסף ושיעור נוסף</p>
      </div>

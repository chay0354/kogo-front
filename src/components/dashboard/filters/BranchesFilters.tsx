...
export interface BranchesFiltersState {
  branch_id: string;
  month: number;
  year: number;
  date_from: Date;
...
export function getDefaultBranchesFilters(): BranchesFiltersState {
  const now = new Date();
  return {
    branch_id: 'all',
...
interface Props {
  filters: BranchesFiltersState;
  onFiltersChange: (filters: BranchesFiltersState) => void;
  onExport: () => void;
  branches: Array<{ id: string; name: string }>;
}

export default function BranchesFilters({ filters, onFiltersChange, onExport, branches }: Props) {
